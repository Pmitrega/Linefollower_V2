...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, B_IN2_Pin|A_IN1_Pin|A_IN2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, STBY_Pin|LED2_Pin|LED1_Pin|B_IN1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : B_IN2_Pin A_IN1_Pin A_IN2_Pin */
  GPIO_InitStruct.Pin = B_IN2_Pin|A_IN1_Pin|A_IN2_Pin;
  ...
  /*Configure GPIO pins : STBY_Pin LED2_Pin LED1_Pin B_IN1_Pin */
  GPIO_InitStruct.Pin = STBY_Pin|LED2_Pin|LED1_Pin|B_IN1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
